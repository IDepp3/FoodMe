...
import com.utn.teamA.validaciones.Gson.LocalDateDeserializer;
import com.utn.teamA.validaciones.Gson.LocalDateSerializer;
...
public class AccesoReservas implements ObtenerDatos<Reserva>{
    ...
    public void mostrarJson(Reserva reserva){
            System.out.println(this.json.toJson(reserva));
    }
